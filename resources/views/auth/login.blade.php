...
<div class="min-h-screen bg-gray-100 text-gray-800 antialiased py-6 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 w-72 md:w-96 mx-auto text-center">
        <span class="text-2xl font-dark">Login</span>
            ...
            <div class="px-8 py-6">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex justify-between items-baseline">
                        <button type="submit" class="mt-4 bg-hover text-white py-2 px-6 rounded-md">Login</button>
                        <a href="#" class="text-sm hover:underline">Forgot Password</a>
                    </div>
                </form>
                <p class="text-center mt-4">Belum punya akun? <a href="{{ route('page.register') }}" class="text-indigo-500 hover:underline">Register</a></p>
            </div>
        </div>
    </div>
</div>
